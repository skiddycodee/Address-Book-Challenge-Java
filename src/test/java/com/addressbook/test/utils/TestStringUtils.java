...
public class  TestStringUtils {
        ...
        class Statement3Tests {
            ...
            public void testCheckIfInputNotNull() {
                assertThrows(IllegalArgumentException.class, () -> StringUtils.contactInputQuarantine(null));
            }

            @Test
            public void testCheckIfInputNotEmpty() {
                assertThrows(IllegalArgumentException.class, () -> StringUtils.contactInputQuarantine(""));
            }
            ...
            public void testCheckIfPhoneNumberValid() {
                assertAll(
                        //! Test data for valid phone numbers are AI generated by ChatGPT
                        //! AI was prompted with "Generate test data for valid phone numbers"
            ...
            public void testCheckIfEmailValid() {
                assertAll(
                        //! Test data for valid emails are AI generated by ChatGPT
                        //! AI was prompted with "Generate test data for valid emails"
                        //! "I want x format, and to test this regex"
            ...
            public void testCheckIfNameValid() {
                assertAll(
                        //! Test data for valid names are AI generated by ChatGPT
                        //! AI was prompted with "Generate test data for valid names"
